...
// Estrutura: uploads/{empresa}/pdfs/
$uploadDir = $baseUploadDir . $companyFolder . '/pdfs/';
...
if (is_array($files['name'])) {
    ...
    for ($i = 0; $i < $fileCount; $i++) {
        ...
        $result = processPDFUpload($fileName, $fileTmpName, $fileSize, $fileError, $uploadDir, $allowedExtensions, $maxFileSize, $companyFolder);
    ...
    // Single file
    $result = processPDFUpload($files['name'], $files['tmp_name'], $files['size'], $files['error'], $uploadDir, $allowedExtensions, $maxFileSize, $companyFolder);
 ...
 */
function processPDFUpload($fileName, $fileTmpName, $fileSize, $fileError, $uploadDir, $allowedExtensions, $maxFileSize, $companyFolder) {
    ...
    if (move_uploaded_file($fileTmpName, $targetPath)) {
        return [
            ...
            'file' => [
                ...
                'url' => '/uploads/' . $companyFolder . '/pdfs/' . $uniqueFileName,
                'size' => $fileSize,
                'type' => 'pdf',
